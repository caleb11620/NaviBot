...
void initializeSD() {
  ...
  testingFile = SD.open("/test.txt", FILE_WRITE);
  //testingFile.close();
}
...
void testingLog() {
  testingFile = SD.open("/test.txt", FILE_APPEND);
  testingFile.print(left);
  testingFile.print(' ');
  testingFile.print(center);
  testingFile.print(' ');
  testingFile.print(right);
  testingFile.print(' ');
  testingFile.print(angle);
  testingFile.println();
  testingFile.close();
}
